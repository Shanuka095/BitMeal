  ...
  return (
    <div className="w-screen min-h-screen bg-[#e3e3e3] flex flex-col items-center justify-center">
      ...
      <div className="space-x-4">
        <Link to="/login" className="px-4 py-2 bg-[#ffaa00] text-white rounded hover:bg-[#cc8800] transition">
          Sign In
        </Link>
        <Link to="/register" className="px-4 py-2 bg-[#ffaa00] text-white rounded hover:bg-[#cc8800] transition">
          Sign Up
        </Link>
      </div>
    </div>
