  ...
  return (
    <div className="w-screen min-h-screen bg-[#e3e3e3] font-sans text-[#4f4f4f] flex flex-col">
      <div className="flex-grow pt-20">
        ...
        <div className="relative bg-gradient-to-br from-[#1F2937]/80 to-[#1F2937]/50 py-20 md:py-28">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {loading ? (
              ...
              <div className="text-center">
                ...
                <h2 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white mb-2 animate-fade-in tracking-wide">
                  {restaurant.name}
                </h2>
                ...
                <button
                  className="bg-[#ffaa00] text-white px-6 py-3 rounded-lg hover:bg-[#cc8800] transition-colors duration-200 font-semibold"
        ...
        {!loading && !error && restaurant && (
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <h3 className="text-4xl font-bold text-[#4f4f4f] mb-10 text-center tracking-wide">Our Menu</h3>
            {Object.keys(groupedMenu).length === 0 ? (
              <p className="text-[#4f4f4f] text-center text-lg font-medium">No menu items available</p>
            ) : (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {items.map((item, index) => (
                      ...
                      >
                        ...
                        <button
                          className="w-full mt-4 py-2 bg-[#ffaa00] text-white rounded-lg hover:bg-[#cc8800] transition-colors duration-200 flex items-center justify-center gap-2 font-semibold"
                          onClick={(e) => {
                            e.stopPropagation();
