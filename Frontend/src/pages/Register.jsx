    ...
    <div className="w-screen min-h-screen bg-[#e3e3e3] flex flex-col">
      <div className="flex-grow flex items-center justify-center p-4">
        <div className="w-full max-w-md bg-white/95 rounded-2xl shadow-2xl p-8 border border-[#ffaa00]/20">
          <h2 className="text-3xl font-extrabold text-[#4f4f4f] mb-6 text-center tracking-wide">Join BitMeal</h2>
          <form onSubmit={handleRegister} className="space-y-6">
            ...
            <div>
              <label htmlFor="role" className="block text-sm font-medium text-[#4f4f4f] mb-2">Role</label>
              <select
                id="role"
                value={role}
                onChange={(e) => setRole(e.target.value)}
                className="w-full px-4 py-3 bg-[#f5f5f5] text-[#4f4f4f] rounded-lg border border-[#ffaa00]/20 focus:ring-2 focus:ring-[#ffaa00] focus:border-transparent transition-all duration-200"
              >
          ...
          <p className="text-[#4f4f4f] text-sm text-center mt-6">
            ...
            <Link to="/login" className="text-[#ffaa00] hover:underline font-medium transition-all duration-200">
              Login
            </Link>
          </p>
        </div>
