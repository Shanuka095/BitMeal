        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-32">
          {services.map((service, index) => (
            <div 
              ...
              // Applied the exact 'cardBase' style from About Us
              className={`p-10 rounded-[2.5rem] border backdrop-blur-xl transition-all duration-500 group animate-fade-in-up cursor-default transform hover:-translate-y-4 hover:scale-[1.02] ${cardBase}`}
            >
